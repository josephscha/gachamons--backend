...
Item.create(name: "Tamago", price: 1000, description: "Summon a random monster!")
Item.create(name: "Lady Egga", price: 50000, description: "Summon a random Epic and higher monster!")
Item.create(name: "Pikapika Egg", price: 100000, description: "Summon a LEGENDARY Monster!")
